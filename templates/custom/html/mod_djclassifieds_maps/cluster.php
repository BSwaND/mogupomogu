...
<script type="text/javascript">
		...
		if(typeof google !== 'undefined' && typeof google.maps !== 'undefined'){
			...
			var djmod_bounds<?php echo $module->id;?> = new google.maps.LatLngBounds();
		}	
		...
		{			
		    ...
		    google.maps.event.addListener(marker,"click",function()
		    {
				...
				djmod_bounds<?php echo $module->id;?>.extend(marker.getPosition());
		    return marker;
		}   	
				 ...
				 document.getElementById("djmod_map_box<?php echo $module->id;?>").style.display='block';
					...
					foreach($items as $item){						
						...
						<?php if($params->get('fit_to_items', '0')){ ?>
							var obj = djmod_bounds<?php echo $module->id;?>;
							var obj_in = obj[Object.keys(obj)[0]];
							if(obj_in[Object.keys(obj_in)[1]] != -1){
								djmod_map<?php echo $module->id;?>.fitBounds(djmod_bounds<?php echo $module->id;?>);
							}
						<?php } ?>
				});					    
		    }  
