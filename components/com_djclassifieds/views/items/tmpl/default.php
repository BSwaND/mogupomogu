...
if($main_id>0 || $main_rid>0 || $se>0 || JRequest::getInt('fav','0') || $uid>0 || ($main_id==0 && $par->get('items_in_main_cat',1)) ){
	...
	<?php	
		...
		<tr class="main_title">
			...
			<?php } ?>
				<a <?php echo $title_a_style;?> class="<?php echo $class; ?>" href="index.php?option=com_djclassifieds&view=items&cid=<?php echo $main_slug; ?>&order=title&ord_t=<?php echo $ord_t.'&Itemid='.$Itemid;?><?php echo $se_link;if($uid){ echo '&uid='.$uid; }?>">
					<?php echo JText::_('COM_DJCLASSIFIEDS_TITLE');
					if($order=="title"){
						if($ord_t=='asc'){ echo '<img src="'.JURI::base(true).'/components/com_djclassifieds/assets/images/sort_desc.gif" alt="" />';
						}else{ echo '<img src="'.JURI::base(true).'/components/com_djclassifieds/assets/images/sort_asc.gif" alt="" />';}					
					}else{	echo '<img src="'.JURI::base(true).'/components/com_djclassifieds/assets/images/sort.gif" alt="sort" />'; }?>
				</a> 
			</th>
			...
			<?php if($par->get('column_category','1')=='2'){$class.=' hide_mobile';}
				...
				<th class="<?php echo $class; ?>">
					<a class="<?php echo $class; ?>" href="index.php?option=com_djclassifieds&view=items&cid=<?php echo $main_slug; ?>&order=cat&ord_t=<?php echo $ord_t.'&Itemid='.$Itemid;?><?php echo $se_link;if($uid){ echo '&uid='.$uid; }?>">
			...
			<th class="<?php echo $class; ?>">
				<a class="<?php echo $class; ?>" href="index.php?option=com_djclassifieds&view=items&cid=<?php echo $main_slug; ?>&order=loc&ord_t=<?php echo $ord_t.'&Itemid='.$Itemid;?><?php echo $se_link;if($uid){ echo '&uid='.$uid; }?>">
			...
			<th class="<?php echo $class; ?>">
				<a class="<?php echo $class; ?>" href="index.php?option=com_djclassifieds&view=items&cid=<?php echo $main_slug; ?>&order=price&ord_t=<?php echo $ord_t.'&Itemid='.$Itemid;?><?php echo $se_link;if($uid){ echo '&uid='.$uid; }?>">
			...
			<th class="<?php echo $class; ?>">
				<a class="<?php echo $class; ?>" href="index.php?option=com_djclassifieds&view=items&cid=<?php echo $main_slug; ?>&order=date_a&ord_t=<?php echo $ord_t.'&Itemid='.$Itemid;?><?php echo $se_link;if($uid){ echo '&uid='.$uid; }?>">
			...
			<th class="<?php echo $class; ?>">
				<a class="<?php echo $class; ?>" href="index.php?option=com_djclassifieds&view=items&cid=<?php echo $main_slug; ?>&order=date_e&ord_t=<?php echo $ord_t.'&Itemid='.$Itemid;?><?php echo $se_link;if($uid){ echo '&uid='.$uid; }?>">
			...
			<th class="<?php echo $class; ?>">
				<a class="<?php echo $class; ?>" href="index.php?option=com_djclassifieds&view=items&cid=<?php echo $main_slug; ?>&order=display&ord_t=<?php echo $ord_t.'&Itemid='.$Itemid;?><?php echo $se_link;if($uid){ echo '&uid='.$uid; }?>">
			...
			<th class="<?php echo $class; ?>">
				<a class="<?php echo $class; ?>" href="index.php?option=com_djclassifieds&view=items&cid=<?php echo $main_slug; ?>&order=distance&ord_t=<?php echo $ord_t.'&Itemid='.$Itemid;?><?php echo $se_link;if($uid){ echo '&uid='.$uid; }?>">
			...
			if($par->get('column_image','1')){		
				echo '<td class="icon first" style="width:'.$icon_col_w.'px" >';						
					echo '<a href="'.DJClassifiedsSEO::getItemRoute($i->id.':'.$i->alias,$i->cat_id.':'.$i->c_alias,$i->region_id.':'.$i->r_name,$this->main_cat,$i->extra_cats).$anch.'">';
						if(count($i->images)){									
							echo '<img src="'.JURI::base(true).$i->images[0]->thumb_table.'"';
				...
				if(isset($i->fields[$cf_active_col[$cf_i]])){
					if($this->custom_fields[$cf_active_col[$cf_i]]->type=='date'){
						if($i->fields[$cf_active_col[$cf_i]]=='0000-00-00'){
							...
							$f = $this->custom_fields[$cf_active_col[$cf_i]];
							if(!$f->date_format){$f->date_format = 'Y-m-d';}
							echo DJClassifiedsTheme::formatDate(strtotime($i->fields[$cf_active_col[$cf_i]]),'','',$f->date_format);
						}
						...
						if($par->get('cf_values_to_labels','0') && !in_array($this->custom_fields[$cf_active_col[$cf_i]]->type, array('inputbox', 'textarea', 'date_from_to'))){
				...
				echo '<td>';
					for($cf_i=0;$cf_i<count($cf_active_all);$cf_i++){
						if(isset($i->fields[$cf_active_all[$cf_i]])){
							echo '<div class="cf_box '.$this->custom_fields[$cf_active_all[$cf_i]]->name.'">';
