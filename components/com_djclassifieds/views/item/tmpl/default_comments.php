	...
	$languge_tag = str_replace('-', '_', $lang->getTag());
		if($par->get('comments','0') == 1){?>
			<div class="djcf_comments fb_comments_box">
				...
				<div class="fb-comments" data-href="<?php echo $uri->toString(); ?>" data-num-posts="<?php echo $par->get('fb_comments_posts','10');?>" data-width="<?php echo intval($par->get('fb_comments_width','550'));?>"></div> 
			</div>
