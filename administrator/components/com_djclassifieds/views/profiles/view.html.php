...
class DjClassifiedsViewProfiles extends JViewLegacy
{
	...
	{	
		...
		$this->batch_usergroups = $this->get('UsergroupsSelect');
	...
	protected function addToolbar()
	{
		...
		if ($user->authorise('core.delete', 'com_djclassifieds')) {
			...
			JToolBarHelper::custom('profiles.clearInactiveData', 'purge', 'purge', 'COM_DJCLASSIFIEDS_CLEAR_INACTIVE_DATA', false);
		}
