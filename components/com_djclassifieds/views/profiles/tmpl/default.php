...
<?php */ ?>
	<?php 
		$page_heading = JText::_('COM_DJCLASSIFIEDS_ALL_PROFILES');
		if($par->get('show_page_heading', '1')){
			if($par->get('page_heading', '')){
				$page_heading = $par->get('page_heading', '');
			}else{
				$page_heading = $par->get('page_title', '');
			}
		}
	?>
	<div class="title_top">
