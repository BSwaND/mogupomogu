        ...
        <div class="additem_djform">
			...
			<div class="additem_djform_in">        	            					               			           	            	
			    ...
			    <div class="djform_row">
					...
					<?php if($par->get('terms',0)>0 && $par->get('terms_article_id',0)>0 && $this->terms_link){ ?>				
	 	...
	 	<?php if(count($this->custom_contact_fields) || count($this->custom_fields_groups) || $par->get('profile_avatar_source','')=='' || $par->get('registration_regions','0') || $par->get('registration_address','0') || $par->get('registration_postcode','0')){?>
