...
class DjclassifiedsViewCpanel extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		$del_exp_days = $par->get('auto_delete_expired', '0');
		if($del_exp_days){
			JLoader::register('DJClassifiedsControllerItems', JPATH_COMPONENT_ADMINISTRATOR.'/controllers/items.php');
			$controller = new DJClassifiedsControllerItems();	
			$controller->deleteExpired($del_exp_days);
		}
