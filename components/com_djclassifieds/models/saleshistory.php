...
class DjclassifiedsModelSalesHistory extends JModelLegacy{	
	...
	function getOrders(){
		...
		$db			= JFactory::getDBO();
			...
			$query = "SELECT o.*, i.name as i_name, i.alias as i_alias, i.cat_id, i.currency, i.region_id, c.alias as c_alias, r.name as r_name, ".$u_name.", u.email FROM #__djcf_orders o, #__users u, #__djcf_items i "
