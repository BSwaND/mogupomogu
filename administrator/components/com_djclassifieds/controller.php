...
class DJClassifiedsController extends JControllerLegacy
{
	...
	public function display($cachable = false, $urlparams = false)
	{
		...
		if (version_compare($version->getShortVersion(), '3.0.0', '<')) {
			...
			JHtmlSidebar::addEntry(JText::_('COM_DJCLASSIFIEDS_PAYMENT_PLUGINS'), 'index.php?option=com_plugins&view=plugins&filter_folder=djclassifiedspayment', $vName=='plugins');
