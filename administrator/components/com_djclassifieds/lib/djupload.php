...
abstract class DJUploadHelper {
		...
		";
			...
			$js .= "
						...
						FileUploaded: function(up, file, info) {
							...
							".($settings['onUploadedEvent'] ? 'return '.$settings['onUploadedEvent'].'(up,file,info,"'.JURI::root(true).'","'.@$settings['label_generate'].'","'.DJClassifiedsTheme::getImgUploadPath().'");':'')."
						}";
			if($debug) $js .= ",				
						Refresh: function(up) {
	...
	public static function upload() {
		...
		// Settings
		$targetDir = JPATH_ROOT . DJClassifiedsTheme::getImgUploadPath();
