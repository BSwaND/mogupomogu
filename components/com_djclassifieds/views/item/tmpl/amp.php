							...
							if($item->user_id==0){
								...
								<div class="profile_item_box">
									...
									<div class="profile_name_data">
										<?php echo '<a class="profile_name" href="index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.DJClassifiedsSEO::getUserProfileItemid().'"><span itemprop="name" >'.$item->username.'</span> <span>('.$this->user_items_c.')</span></a>'; ?>
