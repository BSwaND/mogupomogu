			...
			<div class="dj-items_order_by">
				<div class="dj-items_order_by_in">
					<div class="dj-items_order_by_label"><?php echo JText::_('COM_DJCLASSIFIEDS_SORT_BY')?></div>															
						...
						<?php if(in_array("title", $sort_fields)){ ?>
						...
						<?php } ?>
						<?php if(in_array("cat", $sort_fields)){ ?>
						...
						<?php } ?>
						<?php if(in_array("loc", $sort_fields)){ ?>
						...
						<?php } ?>
						<?php if(in_array("price", $sort_fields)){ ?>
						...
						<?php } ?>
						<?php if(in_array("date_a", $sort_fields)){ ?>
						...
						<?php } ?>
						<?php if(in_array("date_e", $sort_fields)){ ?>
						<?php if($order=="date_e"){ $sort_class = ($ord_t=="desc")? 'active active_asc' : 'active active_desc'; }else{$sort_class='';}?>
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=date_e&ord_t='.$ord_t.'&Itemid='.$Itemid,false);?>">
							<?php echo JText::_('COM_DJCLASSIFIEDS_DATE_EXPIRATION'); ?>
						</a><span class="item_orderby_separator"></span>
						<?php } ?>
						<?php if(in_array("display", $sort_fields)){ ?>
						...
						<?php } ?>
						<?php if(in_array("distance", $sort_fields)){ ?>
											...
											<div class="item_img_box_in">					
												<a href="<?php echo DJClassifiedsSEO::getItemRoute($i->id.':'.$i->alias,$i->cat_id.':'.$i->c_alias,$i->region_id.':'.$i->r_name).$anch; ?>">
													...
													if(count($i->images)){
														...
														echo '<img style="width:'.$par->get("smallth_width",'56').'px;" src="'.$img_src.'" ';
														if((int)$par->get('tooltip_img','1')){
															echo ' class="Tips1" title="'.$tip_title.'" rel="'.$tip_cont.'"';
														}
														echo ' alt ="'.str_ireplace('"', "'", $i->name).'" ';
