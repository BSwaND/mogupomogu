...
class plgDJClassifiedsPlansInstallerScript
{
    ...
    public function install($parent){
    	$view_xml = JPATH_ROOT.'/components/com_djclassifieds/views/plans/tmpl/';
    	if(JFile::exists($view_xml.'_default.xml')){
    		rename($view_xml.'_default.xml', $view_xml.'default.xml');
    	}
    	$view_xml = JPATH_ROOT.'/components/com_djclassifieds/views/userplans/tmpl/';
    	if(JFile::exists($view_xml.'_default.xml')){
    		rename($view_xml.'_default.xml', $view_xml.'default.xml');
    	}
    }
