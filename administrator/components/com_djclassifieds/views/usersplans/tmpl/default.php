				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td>
						<?php 
							...
							if($item->date_exp == '0000-00-00 00:00:00'){
								echo '<span title="'.$item->date_start.' - '.JText::_('COM_DJCLASSIFIEDS_UNLIMITED').'" >'.JText::_('COM_DJCLASSIFIEDS_UNLIMITED').'</span>';
							}elseif($item->date_exp > $date_now){
