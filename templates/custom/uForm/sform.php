...
$inputs = [
    'form_footer' => [ // id формы
        ...
        'phone' => 'isPhone', // очищает телефон от лишних символов и проверяет на количество цифер (7 - 25)
	      'message' => ['lenStr' => [5, 250, true]], // minLen, maxLen, ture - удалять все
    ]
];
...
$requires = [
    'form_footer' => ['name', 'email','message']
];
...
$files = [
    'idForm' => [
        ...
        'uForm_files' => [
            ...
            'fileFormats' => [['image/jpeg', 'text/plain']] // будет реализованно при первой необходимости. Список всех типов файлов: https://en.wikipedia.org/wiki/Media_type
        ]
    ]
];
