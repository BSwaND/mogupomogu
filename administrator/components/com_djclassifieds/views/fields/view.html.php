...
class DjClassifiedsViewFields extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		if ($user->authorise('core.edit', 'com_djclassifieds') && $this->state->get('filter.source') == '0' && $this->state->get('list.ordering') == 'f.ordering') {
			JToolBarHelper::custom('fields.copyDefaultOrdering', 'out.png', 'copy.png', 'COM_DJCLASSIFIEDS_FIELDS_APPLY_ORDERING_TO_CATEGORIES', true);
		}
	}
}
?>