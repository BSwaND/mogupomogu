							...
							<div class="col-sm-7">
								<div class="adt_item">
									...
									<div class="adt_item_info">
										...
										<?php /*
										<a href="<?= JRoute::_(DJClassifiedsSEO::getCategoryRoute($item->cat_action="/component/djclassifieds/?view=items&se=1"id.':'.$item->c_alias)) ?>" class="adt_item__category"><?= $item->c_name ?></a>
                    */ ?>
