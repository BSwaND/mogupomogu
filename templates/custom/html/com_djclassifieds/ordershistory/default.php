	...
	<?php /*?>
		...
		foreach($this->orders as $order){
			...
			echo '<div class="item_row row'.$row.'">';
				...
				if($order->i_name){
					echo '<div class="item_col icon first"  style="width:'.$icon_col_w.'px"  >';						
						...
						if(count($order->images)){
							...
							echo '<img src="'.JURI::base(true).'/components/com_djclassifieds/assets/images/no-image.png" ';						
				...
				<?php
					$plugin_rows = $dispatcher->trigger('onDJClassifiedsDisplaySalesRow', array (&$order, &$par, 'ordershistory'));			
					$plugin_rows = trim(implode("\n", $plugin_rows));
					echo $plugin_rows;
				?>
				<div class="item_col"> 
					<?php 
