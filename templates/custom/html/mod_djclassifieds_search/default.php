...
<form action="<?php echo JRoute::_($link.'&se=1'); ?>" method="get" name="form-search<?php echo $module->id?>" id="form-search<?php echo $module->id?>">
	...
	if(($params->get('show_postcode','0')==1 || $params->get('show_address','0')==1|| $params->get('show_geoloc','0')==1	) && $params->get('radius_list','')){		
			...
			if((!$s_address_value || JRequest::getVar('se_geoloc','')) && $user_address){
			...
			<div class="search_radius djcf_se_row <?php echo $se_radius_cl;?>">
				<?php if($params->get('show_postcode_label','0')==1){ ?>
	   			...
	   			<?php if($params->get('show_address','0')==1){ ?>
					...
					<input type="hidden" name="se_lat" value="<?php echo JRequest::getVar('se_lat',''); ?>"/>
					<input type="hidden" name="se_lng" value="<?php echo JRequest::getVar('se_lng',''); ?>"/>
		 ...
		 <?php if($params->get('show_cat_label','0')==1){ ?>
			...
			<?php 
				if($params->get('cat_select_type','0')==1){
					...
					$cat_sel = '<select  class="inputbox '.$cat_sel_class.'" id="se'.$module->id.'_cat_0" name="se_cats[]" onchange="se'.$module->id.'_new_cat(0,this.value,new Array());se'.$module->id.'_getFields(this.value);"><option value="">'.JText::_('COM_DJCLASSIFIEDS_PLEASE_SELECT_CATEGORY').'</option>';
	...
	<?php if($params->get('show_only_price_negotiable','0')==1){	?>
			<div class="search_only_price_negotiable djcf_se_row_ch">							
				<input  class="inputbox" <?php if(JRequest::getInt('se_only_price_neg',0)){echo ' checked="checked" ';}?> type="checkbox" name="se_only_price_neg" id="<?php echo $module->id; ?>se_only_price_neg" value="1"/>
				<label class="label" for="<?php echo $module->id; ?>se_only_price_neg"><?php echo JText::_('MOD_DJCLASSIFIEDS_SEARCH_SHOW_ONLY_PRICE_NEGOTIABLE'); ?></label>
			</div>
	<?php }?>	
	<?php if($params->get('show_only_auctions','0')==1){	?>
			<div class="search_only_auctions djcf_se_row_ch">							
				<input  class="inputbox" <?php if(JRequest::getInt('se_only_auctions',0)){echo ' checked="checked" ';}?> type="checkbox" name="se_only_auctions" id="<?php echo $module->id; ?>se_only_auctions" value="1"/>
				<label class="label" for="<?php echo $module->id; ?>se_only_auctions"><?php echo JText::_('MOD_DJCLASSIFIEDS_SEARCH_SHOW_ONLY_AUCTIONS'); ?></label>
			</div>
	<?php }?>
	<?php if($params->get('show_only_buynow','0')==1){	?>
			<div class="search_only_buynow djcf_se_row_ch">							
				<input  class="inputbox" <?php if(JRequest::getInt('se_only_buynow',0)){echo ' checked="checked" ';}?> type="checkbox" name="se_only_buynow" id="<?php echo $module->id; ?>se_only_buynow" value="1"/>
				<label class="label" for="<?php echo $module->id; ?>se_only_buynow"><?php echo JText::_('MOD_DJCLASSIFIEDS_SEARCH_SHOW_ONLY_BUYNOW'); ?></label>
			</div>
	<?php }?>	
	<?php if($params->get('show_only_images','0')==1){	?>
			<div class="search_only_images djcf_se_row_ch">							
				<input  class="inputbox" <?php if(JRequest::getInt('se_only_img',0)){echo ' checked="checked" ';}?> type="checkbox" name="se_only_img" id="<?php echo $module->id; ?>se_only_img" value="1"/>
				<label class="label" for="<?php echo $module->id; ?>se_only_img"><?php echo JText::_('MOD_DJCLASSIFIEDS_SEARCH_SHOW_ONLY_WITH_IMAGES'); ?></label>
			</div>
	<?php }?>
	<?php if($params->get('show_only_video','0')==1){	?>
			<div class="search_only_video djcf_se_row_hc">							
				<input  class="inputbox" <?php if(JRequest::getInt('se_only_video',0)){echo ' checked="checked" ';}?> type="checkbox" name="se_only_video" id="<?php echo $module->id; ?>se_only_video" value="1"/>
				<label class="label" for="<?php echo $module->id; ?>se_only_video"><?php echo JText::_('MOD_DJCLASSIFIEDS_SEARCH_SHOW_ONLY_WITH_VIDEO'); ?></label>
			</div>
	<?php }?>
	<?php if($params->get('show_restriction_18','0')==1){	?>
			<div class="search_also_18 djcf_se_row_ch">							
				<input  class="inputbox" <?php if(JRequest::getInt('se_also_18',0)){echo ' checked="checked" ';}?> type="checkbox" name="se_also_18" id="<?php echo $module->id; ?>se_also_18" value="1"/>
				<label class="label" for="<?php echo $module->id; ?>se_also_18"><?php echo JText::_('MOD_DJCLASSIFIEDS_SEARCH_SHOW_RESTRICTION_18_LABEL'); ?></label>
			</div>
	<?php }?>
