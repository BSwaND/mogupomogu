...
?>
        ...
        <?php if(count($this->regions) && $par->get('show_regions','1') && $par->get('registration_regions','0')){?>
            ...
            <?php } ?>
            <?php if($par->get('show_address','1') && $par->get('registration_address','0')){?>
	            <div class="djform_row">
	                <?php if($par->get('show_tooltips_newad','0')){ ?>
	                ...
	                <div class="djform_field">
	                    <input class="text_area" type="text" name="address" id="address" size="50" maxlength="250" value="" />
	                </div>
	                <div class="clear_both"></div> 
	            </div>
            <?php } ?>      
            
            <?php if($par->get('show_postcode','0') && $par->get('registration_postcode','0')){?>
            	<div class="djform_row">
            		<?php if($par->get('show_tooltips_newad','0')){ ?>
	            	...
	            	<?php } ?>
	                <div class="djform_field">
	                    <input class="text_area" type="text" name="post_code" id="post_code" size="50" maxlength="250" value="" />
	                </div>
	                <div class="clear_both"></div> 
	            </div>             
            <?php
			 }       
			if($par->get('allow_user_lat_lng','0') && $par->get('registration_regions','0')){ ?>
            	<div class="djform_row" <?php if($par->get('allow_user_lat_lng','0')==2){echo 'style="display:none;"';} ?> >
	            	...
	            	<?php } ?>
	                <div class="djform_field">
	                    <input class="text_area" type="text" name="latitude" id="latitude" size="50" maxlength="250" value="" />
	                </div>
	                <div class="clear_both"></div> 
	            </div>   
	            <div class="djform_row" <?php if($par->get('allow_user_lat_lng','0')==2){echo 'style="display:none;"';} ?> >
	            	...
	            	<?php } ?>
	                <div class="djform_field">
	                    <input class="text_area" type="text" name="longitude" id="longitude" size="50" maxlength="250" value="" />
	                </div>
	                <div class="clear_both"></div> 
	            </div>	            
	            <div class="djform_row">
...
<script type="text/javascript">	
	...
	function getCities(region_id){
		...
		if(region_id>0){
			...
			var url = '<?php echo JURI::base()?>index.php?option=com_djclassifieds&view=additemtask=getCities&r_id=' + region_id;
				var myRequest = new Request({
					    url: '<?php echo JURI::base()?>index.php',
					    method: 'post',
						data: {
	...
	<?php if($par->get('allow_user_lat_lng','0') && $par->get('registration_regions','0')){ 
