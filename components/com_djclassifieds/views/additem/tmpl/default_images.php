...
$document->addScript(JURI::root(true).'/components/com_djclassifieds/assets/djuploader.js');
$settings = array();
				...
				<div id="itemImages">
					<?php  if($this->images) foreach($this->images as $img) { ?>
						<div class="itemImage">
							...
							<?php }else{ ?>
								<img src="<?php echo JURI::root(true).$img->path.$img->name.'.'.$img->ext; ?>" alt="<?php echo $this->escape($img->caption); ?>" />
							<?php }?>
							<div class="imgMask">
