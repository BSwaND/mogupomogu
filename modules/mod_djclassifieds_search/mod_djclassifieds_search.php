...
$dispatcher->trigger('onPrepareDJClassifiedsSearchModule', array($params, $module));
...
if($layout=='horizontal'){
	...
	$cal_styles = ".search_ex_fields .djseform_field .field-calendar input.djsecal{width: 75px !important;margin: 0 5px;	}.search_ex_fields .djseform_field .field-calendar{display:inline-block;}";
	$document->addStyleDeclaration($cal_styles);
