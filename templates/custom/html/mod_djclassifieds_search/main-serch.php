		...
		<form action="<?php echo JRoute::_($link.'&se=1'); ?>" method="get" name="form-search<?php echo $module->id?>" id="form-search<?php echo $module->id?>" class="form_search">
			...
			<?php if($params->get('show_input','1')==1){ ?>
				<div class="search_word djcf_se_row">
					...
					<input type="text" id="input_search<?php echo $module->id?>" size="12" name="search" class="inputbox first_input form_search__input" value="<?php echo $s_value; ?>" placeholder="Введите свой город или вещь, которую ищете" />  
				</div>
			<?php } ?>
