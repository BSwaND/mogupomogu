...
class DjClassifiedsModelPayments extends JModelList{
	...
	function getAdvertPaymentSubtypes(){
		$subtypes = array(
			JHtml::_('select.option', 'cat', JText::_('COM_DJCLASSIFIEDS_CATEGORY')),
			JHtml::_('select.option', 'type', JText::_('COM_DJCLASSIFIEDS_TYPE')),
			JHtml::_('select.option', 'duration', JText::_('COM_DJCLASSIFIEDS_DURATION')),
			JHtml::_('select.option', 'p_first', JText::_('COM_DJCLASSIFIEDS_PROMOTION_FIRST')),
			JHtml::_('select.option', 'p_bold', JText::_('COM_DJCLASSIFIEDS_PROMOTION_BOLD')),
			JHtml::_('select.option', 'p_border', JText::_('COM_DJCLASSIFIEDS_PROMOTION_BORDER')),
			JHtml::_('select.option', 'p_bg', JText::_('COM_DJCLASSIFIEDS_PROMOTION_BG')),
			JHtml::_('select.option', 'p_special', JText::_('COM_DJCLASSIFIEDS_PROMOTION_SPECIAL'))
		);
		return $subtypes;
	}
}
