	...
	echo '<div class="title_top info" ><h2 itemprop="name" >'.$item->name.'</h2>';
		...
		if($par->get('sb_position','0')=='top' && $par->get('sb_code','')!=''){
		 ...
		 if($par->get('show_print_icon','0')){
			$print_url = clone JURI::getInstance();
			$print_url->setVar('tmpl','component');
			echo '<a class="print_icon" target="_blank" href="'.$print_url.'" title="'.JText::_('COM_DJCLASSIFIEDS_PRINT_VIEW').'">';
