					...
					<div class="djcf_prow"><div class="djcf_prow_in">								
						<div class="djcf_prow_col_desc">
							...
							<div class="djcf_prow_desc_row">								
								...
								<span class="djcf_prow_desc_value" ><?php echo $plan_params->ad_limit == '-1' ? JText::_("COM_DJCLASSIFIEDS_UNLIMITED") : $plan_params->ad_limit; ?></span>
							...
							<div class="djcf_prow_desc_row">								
								...
								<span class="djcf_prow_desc_value" >
									...
									if($plan_params->days_limit>0){
										...
										echo JText::_("COM_DJCLASSIFIEDS_NEVER");
									}?>
								</span>
								<div class="clear_both"></div>
							</div>
