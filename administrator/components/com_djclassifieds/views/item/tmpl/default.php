							...
							<div class="tab-pane" id="publishing">
								...
								<div class="control-group">
									<div class="control-label">
										...
										<br /><span style="color:#666;font-size:11px"><?php echo JText::_('COM_DJCLASSIFIEDS_PAID_DESC');?></span>
									</div>
									<div class="controls">
								...
								<div class="control-group">
									<div class="control-label"><?php echo JText::_('COM_DJCLASSIFIEDS_DISPLAY');?></div>
									<div class="controls">
										<?php echo $this->item->display; ?>
									</div>
								</div>
								<div class="control-group">
											...
											if($prom_active){												
												...
												<div class="djform_prom_adet_expiration">
													...
													<span class="djform_prom_adet_value">	
														        ...
														        <img class="calendar" src="components/com_djclassifieds/assets/images/calendar.png" alt="calendar" id="<?php echo $prom->name.'_';?>showArrivalCalendar" />
														        <script type="text/javascript">
														         var startDate = new Date(2008, 8, 7);
														         Calendar.setup({
													...
													<span class="djform_prom_adet_value">	
															<input class="inputbox" type="text" name="<?php echo $prom->name.'_';?>time_expir" value="<?php echo $prom_time_exp; ?>" size="10" />
													</span>	
												</div>
											<?php } ?>										
										</div>
								...
								<div id="itemImagesWrap">
									<div id="itemImages" class="adminItemImages">
										...
										foreach($this->images as $img) { ?>
											<div class="itemImage">
												<img src="<?php echo JURI::root(true).$img->path.$img->name.'_thb.'.$img->ext; ?>" alt="<?php echo $this->escape($img->caption); ?>" />
												<div class="imgMask">
...
<script language="javascript" type="text/javascript">
	...
	function confirm_delete_bid(id,bid){
		...
		var answer = confirm ('<?php echo DJClassifiedsTheme::sanitizePopupText(JText::_('COM_DJCLASSIFIEDS_CONFIRM_DELETE_BID')); ?>');
		if (answer){
	...
	function confirm_delete_buynow(id,bid){
		...
		var answer = confirm ('<?php echo DJClassifiedsTheme::sanitizePopupText(JText::_('COM_DJCLASSIFIEDS_CONFIRM_DELETE_PURCHASE')); ?>');
		if (answer){
