...
?>
					...
					<div class="tab-pane" id="a_restrictions">
						...
						<div class="control-group">
							<div class="control-label">
								<?php echo JText::_('COM_DJCLASSIFIEDS_CATEGORY_ADS_LIMIT');?>
								<br><span style="color:#666;font-size:11px"><?php echo JText::_('COM_DJCLASSIFIEDS_CATEGORY_ADS_LIMIT_DESC');?></span>
							</div>
							<div class="controls">
								<input class="text_area" type="text" name="ads_limit" size="20" maxlength="250" value="<?php echo $this->category->ads_limit; ?>" />
							</div>
						</div>
					</div>									
							...
							<div class="controls">
			                    <?php
									if(!$this->images){
										...
										echo '<img src="'.JURI::root(true).$icon_img->path.$icon_img->name.'_ths.'.$icon_img->ext.'" />';?>
	...
	function confirm_assign_fields(id){	
		var answer = confirm ('<?php echo DJClassifiedsTheme::sanitizePopupText(JText::_('COM_DJCLASSIFIEDS_ASSIGN_CUSTOM_FIELDS_TO_SUBCATEGORIES_WARNING')); ?>');
		if (answer){
