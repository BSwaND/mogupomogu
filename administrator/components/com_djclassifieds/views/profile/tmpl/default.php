						...
						<div class="tab-content">
										...
										<div class="controls">
						                    <?php
												if(!$this->images){
													...
													echo '<img src="'.JURI::root(true).$avatar_img->path.$avatar_img->name.'_th.'.$avatar_img->ext.'" />';?>
							...
							<div class="tab-pane" id="location">
								...
								<div class="control-group">
									<div class="control-label"></div>
									<div class="controls">
										<?php if($par->get('show_googlemap')==1 && $this->profile->latitude && $this->profile->longitude && $this->profile->latitude!='0.000000000000000' && $this->profile->longitude!='0.000000000000000'){ ?>
											<fieldset class="adminform">
										...
										<?php }elseif($this->profile->latitude!='0.000000000000000' && $this->profile->longitude!='0.000000000000000'){ ?>
											<fieldset class="adminform">
												<legend><?php echo JText::_('COM_DJCLASSIFIEDS_LOCALIZATION'); ?></legend>
												<?php if($this->profile->event->onBeforeDJClassifiedsDisplayProfileMap) { ?>
												<div class="djcf_custom_map">
													<?php echo $this->profile->event->onBeforeDJClassifiedsDisplayProfileMap; ?>
												</div>
												<?php } ?>	
											</fieldset>	
										<?php } ?>											
